      ...
      <div className="bg-background min-h-screen">
        <div className="container mx-auto px-4 py-16">
          ...
          <ScrollAnimate animation="fade-in-up">
            <section className="bg-white border-2 border-border rounded-none p-8 lg:p-12 relative">
              ...
              <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
                <div className="lg:col-span-4 border-b-2 lg:border-b-0 lg:border-r-2 border-border/10 pb-8 lg:pb-0 pr-0 lg:pr-8">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="p-4 bg-primary text-white rounded-none shrink-0 shadow-[4px_4px_0px_0px_rgba(45,74,62,1)]">
                      <ShieldCheck className="h-8 w-8" />
                    </div>
                  </div>
                  <h2 className="text-4xl font-heading font-bold text-foreground mb-4">Chính sách bảo hành</h2>
                ...
                <p className="flex items-center gap-3">
                  ...
                  <strong className="text-foreground uppercase tracking-wider text-sm">Thời hạn bảo hành:</strong> 
                  <span>3 tháng kể từ ngày mua hàng.</span>
                </p>

                <div className="bg-background p-6 border border-border/10">
                  <strong className="text-foreground uppercase tracking-wider text-sm block mb-4 border-b border-border/10 pb-2">Điều kiện bảo hành:</strong>
            ...
            <section className="bg-white border-2 border-border rounded-none p-8 lg:p-12 relative">
              ...
              <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
                <div className="lg:col-span-4 border-b-2 lg:border-b-0 lg:border-r-2 border-border/10 pb-8 lg:pb-0 pr-0 lg:pr-8">
                  ...
                  <h2 className="text-4xl font-heading font-bold text-foreground mb-4">Chính sách đổi trả</h2>
                ...
                <p className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-emerald-500 rounded-none"></span>
                  <strong className="text-foreground uppercase tracking-wider text-sm">Thời hạn đổi trả:</strong> 
                  <span>7 ngày kể từ ngày nhận hàng.</span>
                </p>

                <div className="bg-background p-6 border border-border/10">
                  <strong className="text-foreground uppercase tracking-wider text-sm block mb-4 border-b border-border/10 pb-2">Điều kiện đổi trả:</strong>
                  <ul className="list-none mt-2 space-y-3">
                ...
                <div className="bg-white p-6 border border-border/20">
                  <strong className="text-foreground uppercase tracking-wider text-sm block mb-4 border-b border-border/10 pb-2">Quy trình đổi trả:</strong>
                  <ol className="list-none mt-2 space-y-4">
                    <li className="flex items-start gap-3"><span className="font-bold text-foreground w-6">01.</span> Liên hệ hotline hoặc email để yêu cầu đổi trả</li>
                    <li className="flex items-start gap-3"><span className="font-bold text-foreground w-6">02.</span> Gửi hình ảnh sản phẩm lỗi (nếu có)</li>
                    <li className="flex items-start gap-3"><span className="font-bold text-foreground w-6">03.</span> Chờ xác nhận từ B-ECO (trong vòng 24h)</li>
                    <li className="flex items-start gap-3"><span className="font-bold text-foreground w-6">04.</span> Gửi trả sản phẩm theo hướng dẫn</li>
                    <li className="flex items-start gap-3"><span className="font-bold text-foreground w-6">05.</span> Nhận sản phẩm mới hoặc hoàn tiền trong 3-5 ngày làm việc</li>
                  </ol>
                </div>
            ...
            <section className="bg-white border-2 border-border rounded-none p-8 lg:p-12 relative">
              ...
              <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
                <div className="lg:col-span-4 border-b-2 lg:border-b-0 lg:border-r-2 border-border/10 pb-8 lg:pb-0 pr-0 lg:pr-8">
                  ...
                  <h2 className="text-4xl font-heading font-bold text-foreground mb-4">Chính sách bảo mật</h2>
                ...
                <div className="border-l-4 border-border pl-6">
                  <strong className="text-foreground font-heading text-xl block mb-2">1. Mục đích thu thập thông tin</strong>
                  <p>
                ...
                <div className="border-l-4 border-border pl-6">
                  <strong className="text-foreground font-heading text-xl block mb-2">2. Phạm vi thu thập</strong>
                  <p>
                ...
                <div className="border-l-4 border-border pl-6">
                  <strong className="text-foreground font-heading text-xl block mb-2">3. Thời gian lưu trữ</strong>
                  <p>
                ...
                <div className="border-l-4 border-border pl-6">
                  <strong className="text-foreground font-heading text-xl block mb-2">4. Chia sẻ thông tin</strong>
                  <p>
                ...
                <div className="border-l-4 border-border pl-6">
                  <strong className="text-foreground font-heading text-xl block mb-2">5. Quyền của khách hàng</strong>
                  <p>Bạn có quyền:</p>
                ...
                <div className="border-l-4 border-border pl-6">
                  <strong className="text-foreground font-heading text-xl block mb-2">6. Bảo mật</strong>
                  <p>
          ...
          <ScrollAnimate animation="fade-in-up" delay={300}>
            <section className="bg-primary text-white rounded-none border border-secondary p-12 text-center relative overflow-hidden">
