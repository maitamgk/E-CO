      ...
      <div className="bg-gradient-to-br from-primary/10 to-primary/5 min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl">
            <h1 className="text-5xl lg:text-7xl font-heading font-bold text-[#1e332a] mb-6">
      ...
      <div className="container mx-auto px-4 py-16 space-y-24">
          ...
          <ScrollAnimate animation="fade-in-left">
            <div>
              <div className="p-3 bg-primary/10 rounded-none border border-primary/20 inline-block mb-4">
                <Leaf className="h-8 w-8 text-[#1e332a]" />
              </div>
              <h2 className="text-4xl font-heading font-bold mb-4 text-[#1e332a]">Khởi nguồn từ Phú Yên</h2>
          ...
          <ScrollAnimate animation="fade-in-right" delay={200}>
            <div className="relative">
              <img
                ...
                loading="lazy"
              />
              <div className="absolute -bottom-4 -left-4 bg-[#1e332a] border border-[#2d4a3e] text-white p-4 rounded-none shadow-lg">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <ScrollAnimate animation="fade-in-left">
            <div className="order-2 md:order-1 relative">
              <img
                ...
                loading="lazy"
              />
              <div className="absolute -bottom-4 -right-4 bg-[#1e332a] border border-[#2d4a3e] text-white p-4 rounded-none shadow-lg">
          ...
          <ScrollAnimate animation="fade-in-right" delay={200}>
            <div className="order-1 md:order-2">
              <div className="p-3 bg-primary/10 rounded-none border border-primary/20 inline-block mb-4">
                <Heart className="h-8 w-8 text-[#1e332a]" />
              </div>
              <h2 className="text-4xl font-heading font-bold mb-4 text-[#1e332a]">Sứ mệnh của chúng tôi</h2>
              <p className="text-muted-foreground leading-relaxed text-lg">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <ScrollAnimate animation="fade-in-left">
            <div>
              <div className="p-3 bg-primary/10 rounded-none border border-primary/20 inline-block mb-4">
                <Globe className="h-8 w-8 text-[#1e332a]" />
              </div>
              <h2 className="text-4xl font-heading font-bold mb-4 text-[#1e332a]">Bảo vệ biển Phú Yên</h2>
              <p className="text-muted-foreground leading-relaxed text-lg">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <ScrollAnimate animation="fade-in-right" delay={200}>
            <div className="order-1 md:order-2">
              <div className="p-3 bg-primary/10 rounded-none border border-primary/20 inline-block mb-4">
                <Users className="h-8 w-8 text-[#1e332a]" />
              </div>
              <h2 className="text-4xl font-heading font-bold mb-4 text-[#1e332a]">Cộng đồng bền vững</h2>
              <p className="text-muted-foreground leading-relaxed text-lg">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <ScrollAnimate animation="fade-in-up">
            <h2 className="text-4xl font-heading font-bold text-center mb-12 text-[#1e332a]">Giá trị cốt lõi</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={idx} className="text-center bg-[#1e332a] text-white border border-[#2d4a3e] rounded-none p-8 shadow-xl">
